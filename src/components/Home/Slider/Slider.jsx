  ...
  return (
    <div className="w-[100%] h-[170px] md:h-[auto] md:w-[87%] md:m-auto relative">
      <img
        ...
        className=" h-[100%]"
      />
      <div className=" absolute top-[20%] left-[36%] md:top-[25%] md:left-[43%]">
        <h2 className="text-white text-[23px] md:text-[44px] font-bold">
          Shop List
        </h2>
      </div>
      <ul className="flex items-center absolute top-[45%] left-[15%] md:top-[45%] md:left-[38%] text-white text-[18px] font-medium">
